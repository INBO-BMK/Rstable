...
RUN  ./cran_install.sh crayon 1.3.4 \
...
RUN  ./cran_install.sh stringdist 0.9.4.6 \
...
## install plotly
RUN  ./cran_install.sh httpuv 1.3.5 \
...
## install osmar
RUN  ./cran_install.sh XML 3.98-1.9 \
